...
export default function Answer({ onPlaySound }: { onPlaySound: () => void }) {
  const { currentStatement: getCurrentStatement, toNextStatement } =
    useCourse();
  ...
  function handleToNextStatement() {
    useCourse.setState({ currentMode: "question" });
    toNextStatement();
  }
